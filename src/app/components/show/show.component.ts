...
export class ShowComponent implements OnInit {
  ...
  competitions: any[] = [
    {name: "cake tasting", text: "What is a wedding without cake. The Cake tasting will begin every hour on the hour, with a minimum of 3 different tastings. Why not take part to find a cake and flavour for your wedding? All you need to do is put your name down at the cake tasting stand to be allocated a slot. First come first serve.", image: "assets/img/galleries/main/6.jpg"},
    {name: "table décor", text: "Be a judge and you could stand a chance to win a fantastic prize. Visitors enter at the table decor activation area.", image: "assets/img/ex-ct.jpg", url: "http://www.google.com" }   
  ];
