...
export class UpcomingExposComponent implements OnInit {
  ...
  expos: any[] = [
    {name: "Johannesburg", location: "Ticketpro Dome", dates: "10 & 11 march 2018", details: "Price: <b>R120.00</b> per person<br>R30 per child (2 to 10 years)", button: "coming soon"},
